      ...
      <Layer position="right" full="vertical" onEsc={onClose}>
        <Box direction="column" pad={{ horizontal: 'medium' }}>
          ...
          <Paragraph margin={{ bottom: 'xsmall', top: 'xsmall' }} size="small">
            *Хэш - это строка, состоящая из букв и цифр фиксированной длины строго соответствующая
            изображению). Хэш позволяет гарантировать, что ответы-предсказания не могут быть
            незаметно изменены, так как при любом изменении (даже в одном знаке) хэш будет абсолютно
            другой.
          </Paragraph>
